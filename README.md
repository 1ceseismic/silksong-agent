...
1. [`docs/framework-requirements.md`](./docs/framework-requirements.md) — canonical spec: obs/action contract, throughput floor, toolchain, build, file tree, phase status.
...
- `dotnet build plugin` — plugin is copied into `BepInEx/plugins/` automatically.
...
remain only so existing 30 M-step checkpoints stay reproducible.
