...
public static class RaycastSensor
{
    ...
    private static readonly List<(Vector2 position, float radius)> projectiles = new();
    ...
    private static readonly float[] distancesBuffer = new float[Constants.RayCount];
    private static readonly RaycastHitType[] hitTypesBuffer = new RaycastHitType[Constants.RayCount];
